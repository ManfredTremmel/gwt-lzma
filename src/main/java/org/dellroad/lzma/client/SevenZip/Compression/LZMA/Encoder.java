...
public class Encoder
{
	...
	class LiteralEncoder
	{
		class Encoder2
		{
			...
			public void Init() { org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(m_Encoders); }



			public void Encode(org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder rangeEncoder, byte symbol) throws IOException
			{
				int context = 1;
				for (int i = 7; i >= 0; i--)
				{
			...
			public void EncodeMatched(org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder rangeEncoder, byte matchByte, byte symbol) throws IOException
			{
				int context = 1;
				boolean same = true;
				for (int i = 7; i >= 0; i--)
			...
			public int GetPrice(boolean matchMode, byte matchByte, byte symbol)
			{
				...
				if (matchMode)
				{
					for (; i >= 0; i--)
					{
						int matchBit = (matchByte >> i) & 1;
						int bit = (symbol >> i) & 1;
						price += org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice(m_Encoders[((1 + matchBit) << 8) + context], bit);
						context = (context << 1) | bit;
						if (matchBit != bit)
						{
							i--;
				...
				{
					int bit = (symbol >> i) & 1;
					price += org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice(m_Encoders[context], bit);
					context = (context << 1) | bit;
				}
				return price;
			}
	...
	class LenEncoder
	{
		...
		{
			org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_choice);
		...
		public void Encode(org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder rangeEncoder, int symbol, int posState) throws IOException
		{
		...
		{
			int a0 = org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_choice[0]);
			int a1 = org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_choice[0]);
			int b0 = a1 + org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_choice[1]);
			int b1 = a1 + org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_choice[1]);
			int i = 0;
	...
	org.dellroad.lzma.client.SevenZip.Compression.LZ.BinTree _matchFinder = null;
	org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder _rangeEncoder = new org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder();
	...
	void Create()
	{
		...
		{
			org.dellroad.lzma.client.SevenZip.Compression.LZ.BinTree bt = new org.dellroad.lzma.client.SevenZip.Compression.LZ.BinTree();
			int numHashBytes = 4;
	...
	void Init()
	{
		...
		org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isMatch);
		org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRep0Long);
		org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRep);
		org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRepG0);
		org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRepG1);
		org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRepG2);
		org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_posEncoders);
	...
	{
		return org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_isRepG0[state]) +
				org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
	}
	...
	int GetPureRepPrice(int repIndex, int state, int posState)
	{
		...
		if (repIndex == 0)
		{
			price = org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_isRepG0[state]);
			price += org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
		}
		else
		{
			price = org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isRepG0[state]);
			if (repIndex == 1)
				price += org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_isRepG1[state]);
			else
			{
				price += org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isRepG1[state]);
				price += org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice(_isRepG2[state], repIndex - 2);
			}
		}
		return price;
	}
	...
	int GetOptimum(int position) throws IOException
	{
		...
		_optimum[1].Price = org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState]) +
				_literalEncoder.GetSubCoder(position, _previousByte).GetPrice(!Base.StateIsCharState(_state), matchByte, currentByte);
		_optimum[1].MakeAsChar();

		int matchPrice = org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState]);
		int repMatchPrice = matchPrice + org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isRep[_state]);
		...
		int normalMatchPrice = matchPrice + org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_isRep[_state]);
		...
		while (true)
		{
			...
			int curAnd1Price = curPrice +
				org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]) +
			...
			matchPrice = curPrice + org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]);
			repMatchPrice = matchPrice + org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isRep[state]);
			...
			if (!nextIsChar && matchByte != currentByte)
			{
				...
				if (lenTest2 >= 2)
				{
					...
					int nextRepMatchPrice = curAnd1Price +
						org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
						org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isRep[state2]);
					{
				...
				if (lenTest < numAvailableBytesFull)
				{
					...
					if (lenTest2 >= 2)
					{
						...
						int curAndLenCharPrice =
								...
								org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
						...
						int nextMatchPrice = curAndLenCharPrice + org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]);
						int nextRepMatchPrice = nextMatchPrice + org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice1(_isRep[state2]);
			...
			if (newLen >= startLen)
			{
				normalMatchPrice = matchPrice + org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.GetPrice0(_isRep[state]);
    ...
    public Chunker CodeInChunks(java.io.InputStream inStream, java.io.OutputStream outStream, long inSize, long outSize) {
		_needReleaseMFStream = false;
        SetStreams(inStream, outStream, inSize, outSize);
	...
	void FillDistancesPrices()
	{
		...
		for (int lenToPosState = 0; lenToPosState < Base.kNumLenToPosStates; lenToPosState++)
		{
			...
			for (posSlot = Base.kEndPosModelIndex; posSlot < _distTableSize; posSlot++)
				_posSlotPrices[st + posSlot] += ((((posSlot >> 1) - 1) - Base.kNumAlignBits) << org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.Encoder.kNumBitPriceShiftBits);
